...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BloctoSDK/BloctoSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Cadence/Cadence.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CryptoSwift/CryptoSwift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FCL/FCL.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FlowSDK/FlowSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/secp256k1Swift/secp256k1Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/secp256k1Wrapper/secp256k1Wrapper.framework"
fi
